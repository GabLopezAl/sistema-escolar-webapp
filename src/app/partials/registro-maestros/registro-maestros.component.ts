...
export class RegistroMaestrosComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // Verificar que materias_json no sea null, undefined o vacío
    if (this.maestro.materias_json && typeof this.maestro.materias_json === "string" && this.maestro.materias_json.trim() !== "") {
      try {
        this.maestro.materias_json = JSON.parse(this.maestro.materias_json);
      } catch (error) {
        console.error("Error al parsear materias_json:", error);
        this.maestro.materias_json = []; // Inicializar como array vacío en caso de error
      }
    }

    // Si sigue sin ser un array, inicializarlo como uno vacío
