...
export class MaestrosScreenComponent implements OnInit {
  ...
  public rol: string = "";
  public token: string = ""; //Para iniciar sesion, visualizar el usuario de acuerdo el token
  ...
  ngOnInit(): void {
    ...
    //Para paginador // Lista donde se muestran los usuarios
    this.initPaginator();
  }

  //Para paginación, inicializar
